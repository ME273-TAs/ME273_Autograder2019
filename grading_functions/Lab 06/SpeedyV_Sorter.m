function [Score, Feedback] = SpeedyV_Sorter(filename)
...
copyfile(filename,'/Volumes/jaredhmt/groups/me-273/Autograder/Student Submissions/Lab06/All Submissions/SpeedyV_XXXX')

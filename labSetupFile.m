...
% Lab 1
L.addLab(1,datetime(2019,12,28,15,50,0),'MATLAB');            % the integers a unique integer identifier - could be negative or strange numbers for test labs
...
% Lab 2
L.addLab(2,datetime(2019,9,23,16,0,0),'MATLAB');        % the integer value is usedeger identifier - could be negative or strange numbers for test labs
...
% Lab 3
L.addLab(3,datetime(2019,9,30,16,0,0),'MATLAB');        % the integer value is useteger identifier - could be negative or strange numbers for test labs
...
% Lab 4
L.addLab(4,datetime(2019,10,7,16,0,0),'MATLAB');        % the integer value is useinteger identifier - could be negative or strange numbers for test labs
...
% Lab 5
L.addLab(5,datetime(2019,10,14,16,0,0),'MATLAB');        % the integer value is usednegative or strange numbers for test labs
...
% Lab 6
L.addLab(6,datetime(2019,10,21,16,0,0),'MATLAB');        % 
L.addLabPart('Speedy',fullfile('Lab 06','Speedy_Grader.m'));    % ditto
L.addLabPart('SpeedyV',fullfile('Lab 06','SpeedyV_Grader.m'));     

% Lab 7
L.addLab(7,datetime(2019,10,28,16,0,0),'MATLAB');        % the integer value is a unique integer identifier - could be negative or strange numbers for test labs
...
% Lab 9
L.addLab(9,datetime(2019,11,18,16,0,0),'C++');        % the integer value is used as a unique integer identifier 
...
% Lab 10
L.addLab(10,datetime(2019,12,2,16,0,0),'C++');        % the integer value is used as a unique integer identifier 
...
% Lab 11
L.addLab(11,datetime(2019,12,9,16,0,0),'C++');        % the integer value is used as a unique integer identifier 
L.addLabPart('Art',fullfile('Lab 11','Art_Grader.m'));     
L.addLabPart('Plate',fullfile('Lab 11','Plate_Grader.m'));            % ditto

% Lab 12
L.addLab(12,datetime(2019,12,9,16,0,0),'MATLAB');        % the integer value is used as a unique integer identifier 

...
% Lab 3
L.addLab(3,datetime(2019,9,28,16,0,0),'MATLAB',2);        % the integer value is useteger identifier - could be negative or strange numbers for test labs
...
% Lab 4
L.addLab(4,datetime(2019,10,5,16,0,0),'MATLAB',2);        % the integer value is useinteger identifier - could be negative or strange numbers for test labs
...
% Lab 7
L.addLab(7,datetime(2019,10,26,16,0,0),'MATLAB',1);        % the integer value is a unique integer identifier - could be negative or strange numbers for test labs
...
% Lab 9
L.addLab(9,datetime(2019,11,9,16,0,0),'C++',2);        % the integer value is used as a unique integer identifier 
...
% Lab 10
L.addLab(10,datetime(2019,11,16,16,0,0),'C++',2);        % the integer value is used as a unique integer identifier 
...
% Lab 11
L.addLab(11,datetime(2019,11,30,16,0,0),'C++',1);        % the integer value is used as a unique integer identifier 
L.addLabPart('Art',fullfile('Lab 11','Art_Grader.m'));     
L.addLabPart('Plate',fullfile('Lab 11','Plate_Grader.m'));            % ditto

% Lab 12
L.addLab(12,datetime(2019,12,7,16,0,0),'MATLAB',1);        % the integer value is used as a unique integer identifier 
